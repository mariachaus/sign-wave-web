...
export const IconImage = ({ size = 14 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
export const IconPlus = ({ size = 14, color }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color || 'currentColor'} strokeWidth="2.5" strokeLinecap="round">
...
export const IconGlobe = ({ size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconPalette = ({ size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconMirror = ({ size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconTextSize = ({ size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    {/* top serif bar */}
    <rect x="3" y="2" width="18" height="2" rx="0.5"/>
    {/* left serif on top bar */}
    <rect x="3" y="2" width="2.2" height="3.2" rx="0.4"/>
    {/* right serif on top bar */}
    <rect x="18.8" y="2" width="2.2" height="3.2" rx="0.4"/>
    {/* vertical stem */}
    <rect x="11" y="2" width="2" height="19" rx="0.5"/>
    {/* bottom left serif */}
    <rect x="8.4" y="18.8" width="3.4" height="2" rx="0.4"/>
    {/* bottom right serif */}
    <rect x="12.2" y="18.8" width="3.4" height="2" rx="0.4"/>
  </svg>
);
