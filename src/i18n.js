    ...
    resources: {
      en: {
        translation: {
          ...
          "detection_tips_title": "Tips for better recognition",
          "detection_tip_lighting": "Improve physical lighting — the most effective fix",
          "detection_tip_clothing": "Wear plain clothing that contrasts with the background",
          "detection_tip_backlight": "Avoid having a bright light source behind you",
          ...
          "sec": "sec",
          "normalize_by_nose": "Normalize by nose",
          "nose_normalization_note": "Coordinates are normalized relative to the nose (landmark 0).",
      ...
      uk: {
        translation: {
          ...
          "detection_tips_title": "Поради для кращого розпізнавання",
          "detection_tip_lighting": "Покращіть освітлення — найефективніший спосіб",
          "detection_tip_clothing": "Носіть однотонний одяг, що контрастує з фоном",
          "detection_tip_backlight": "Уникайте яскравого джерела світла за спиною",
          ...
          "sec": "сек",
          "normalize_by_nose": "Нормалізація відносно носа",
          "nose_normalization_note": "Координати нормалізуються відносно носа (landmark 0).",
