...
const ResultsScreen = ({ score, total, onRestart, onBack, t }) => (
  <div className="ex-page">
    <div className="ex-page__results">
      <div className="ex-page__results-emoji">{score === total ? '🏆' : '💪'}</div>
      ...
      <p className="ex-page__results-sub">
        {score === total ? t('perfect_score') : t('keep_practicing')}
      </p>
...
const WatchReproducePage = ({ models }) => {
  ...
  return (
    <div className="ex-page">
      <div className="page-header">
        ...
        <h2 className="page-header__title">{t('watch_reproduce')}</h2>
      </div>
...
export default WatchReproducePage;
